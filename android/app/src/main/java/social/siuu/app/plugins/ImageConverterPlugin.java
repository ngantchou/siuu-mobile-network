package social.siuu.app.plugins;

import androidx.annotation.NonNull;
import social.siuu.app.ImageConverter;
import social.siuu.app.ImageConverter.TargetFormat;
...
public class ImageConverterPlugin implements MethodCallHandler, FlutterPlugin {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        methodChannel = new MethodChannel(binding.getBinaryMessenger(), "siuu.io/image_converter");
