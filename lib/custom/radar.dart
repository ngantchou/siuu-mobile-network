import 'package:Siuu/database/chat_dao.dart';
import 'package:Siuu/models/chat/Device.dart';
import 'package:Siuu/nearby/Messages/chat_custom.dart';
import 'package:Siuu/res/colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:Siuu/models/chat/chat.dart' as chatModel;
              ...
              child: InkWell(
                onTap: () async {
                  await platform.invokeMethod(
                      "connectToPeer", {"address": element.deviceAddres});
                  ChatDao chatDao = new ChatDao();
                  chatDao.findChat(element.deviceAddres).then((value) {
                    if (value.isEmpty) {
                      print("enregistrement de la discussion");
                      chatDao
                          .insert(chatModel.Chat(
                              element.deviceAddres, element.deviceName))
                          .then((onValue) {
                        return;
                      });
                    }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => Chat(
                              ...
                              chatId: element.deviceAddres,
                              bleAddress: element.bleAddres,
                            )),
                  );
                },
                child: Pic(
