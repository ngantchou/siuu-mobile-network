...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hej, jag vill bjuda in dig till Siuu.\n\nFör Apple, ladda först ner TestFlight-appen från iTunes (${testFlightLink}) och ladda sedan ner Siuu-appen (${iosLink}).\n\nFör Android, ladda ner Siuu-appen från Play Store (${androidLink}).\n\nEfter det så klistrar du in den här personliga inbjudningslänken i \'Registrera dig\'-formuläret i Siuu-appen: ${inviteLink}";
  ...
  static m56(age) => "På Siuu sedan ${age}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Använd länken från Join Siuu-knappen i din inbjudan."),
        ...
        "drawer__main_title": MessageLookupByLibrary.simpleMessage("Mitt Siuu"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Siuus riktlinjer"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Siuus handbok"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "En plats för diskussioner om allt om Siuu"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Stöd Siuu"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Du kan inte använda Siuu förrän du har godkänt riktlinjerna."),
