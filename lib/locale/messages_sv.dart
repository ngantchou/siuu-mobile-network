...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m43(iosLink, androidLink, inviteLink) =>
      "Hej, jag vill bjuda in dig till Siuu. Först, ladda ner appen från iTunes (${iosLink}) eller Play Store (${androidLink}). Sedan klistrar du in din personliga inbjudningslänk i \'Registrera dig\'-formuläret i Siuu-appen: ${inviteLink}";
