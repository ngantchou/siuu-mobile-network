...
import 'package:Siuu/widgets/user_visibility_icon.dart';
...
class OBUserVisibilityPickerBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> columnItems = [
      ...
      const SizedBox(height: 10,),
      OBCheckboxField(
        leading: OBUserVisibilityIcon(visibility: UserVisibility.Siuu,),
        value: _selectedUserVisibility == UserVisibility.Siuu,
        title: _userVisibilitiesLocalizationMap[UserVisibility.Siuu]['title'],
        subtitle: _userVisibilitiesLocalizationMap[UserVisibility.Siuu]
            ['description'],
        onTap: () {
          _setSelectedVisibility(UserVisibility.Siuu);
        },
      ),
      const SizedBox(height: 10,),
      OBCheckboxField(
