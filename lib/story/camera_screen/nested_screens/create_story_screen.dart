...
import 'package:Siuu/story/camera_screen/widgets/custom_text_form.dart';
import 'package:Siuu/story/camera_screen/widgets/duration_form.dart';
import 'package:Siuu/story/camera_screen/widgets/location_form.dart';
import 'package:Siuu/story/core/filtered_image_converter.dart';
import 'package:Siuu/story/core/liquid_swipe_pages.dart';
import 'package:Siuu/story/core/url_validator_service.dart';
import 'package:Siuu/story/storage_service.dart';
...
import 'package:Siuu/story/utilities/filters.dart';
...
class _CreateStoryScreenState extends State<CreateStoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    User _currentUser = _userService.getLoggedInUser();
    setState(() {
      ...
      child: Row(
        ...
        children: <Widget>[
          RaisedButton(
            ...
            onPressed: () => _createStory(_currentUser.uuid),
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  radius: 15.0,
                  backgroundImage: _currentUser.profile.avatar.isEmpty
                      ? AssetImage(placeHolderImageRef)
                      : CachedNetworkImageProvider(_currentUser.profile.avatar),
                ),
                SizedBox(
                  width: 10.0,
                ),
