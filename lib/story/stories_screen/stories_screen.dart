...
import 'package:Siuu/story/stories_screen/widgets/animated_bar.dart';
import 'package:Siuu/story/stories_screen/widgets/story_info.dart';
...
class _StoryScreenState extends State<StoryScreen>
  ...
  Widget build(BuildContext context) {
    ...
    String currentUserId = _userService.getLoggedInUser().uuid;
    return Scaffold(
