...
class OBIcons {
  ...
  static const Siuu_age_baby = OBIconData(nativeIcon: Icons.child_care);
  static const Siuu_age_smile =
  ...
  static const memories = OBIconData(nativeIcon: Icons.bubble_chart);
  ...
  static const privateMemory = OBIconData(nativeIcon: Icons.lock);
  static const publicMemory = OBIconData(nativeIcon: Icons.public);
  static const memoryDescription = OBIconData(nativeIcon: Icons.book);
  static const memoryTitle = OBIconData(nativeIcon: Icons.public);
  static const memoryName = OBIconData(nativeIcon: Icons.public);
  static const memoryRules = OBIconData(nativeIcon: Icons.straighten);
  static const category = OBIconData(nativeIcon: Icons.category);
  static const memoryMember = OBIconData(nativeIcon: Icons.person);
  static const memoryMembers = OBIconData(nativeIcon: Icons.people);
  static const color = OBIconData(nativeIcon: Icons.format_paint);
  static const shortText = OBIconData(nativeIcon: Icons.short_text);
  static const memoryAdministrators = OBIconData(nativeIcon: Icons.star);
  static const memoryModerators = OBIconData(nativeIcon: Icons.gavel);
  static const memoryBannedUsers = OBIconData(nativeIcon: Icons.block);
  static const deleteMemory = OBIconData(nativeIcon: Icons.delete_forever);
  static const seeMore = OBIconData(nativeIcon: Icons.arrow_right);
  static const leaveMemory = OBIconData(nativeIcon: Icons.exit_to_app);
  static const reportMemory = OBIconData(nativeIcon: Icons.flag);
  static const memoryInvites = OBIconData(nativeIcon: Icons.email);
  static const favoriteMemory = OBIconData(nativeIcon: Icons.favorite);
  static const unfavoriteMemory = OBIconData(nativeIcon: Icons.remove_circle);
  ...
  static const excludePostMemory = OBIconData(nativeIcon: Icons.not_interested);
  static const undoExcludePostMemory = OBIconData(nativeIcon: Icons.check);
  ...
  static const memoryStaff = OBIconData(nativeIcon: Icons.tag_faces);
  ...
  static const visibilitySiuu = OBIconData(nativeIcon: Icons.people);
