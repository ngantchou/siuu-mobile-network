...
class OBIcons {
  ...
  static const crewDescription = OBIconData(nativeIcon: Icons.book);
  static const crewTitle = OBIconData(nativeIcon: Icons.public);
  static const crewName = OBIconData(nativeIcon: Icons.public);
  static const crewRules = OBIconData(nativeIcon: Icons.straighten);
  static const category = OBIconData(nativeIcon: Icons.category);
  static const crewMember = OBIconData(nativeIcon: Icons.person);
  static const crewMembers = OBIconData(nativeIcon: Icons.people);
  static const color = OBIconData(nativeIcon: Icons.format_paint);
  static const shortText = OBIconData(nativeIcon: Icons.short_text);
  static const crewAdministrators = OBIconData(nativeIcon: Icons.star);
  static const crewModerators = OBIconData(nativeIcon: Icons.gavel);
  static const crewBannedUsers = OBIconData(nativeIcon: Icons.block);
  ...
  static const crewInvites = OBIconData(nativeIcon: Icons.email);
  ...
  static const crewStaff = OBIconData(nativeIcon: Icons.tag_faces);
