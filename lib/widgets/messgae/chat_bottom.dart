...
//    widget.controller.addListener(_onInputChange);
  ...
  Widget mKeyBoardButton() {
    return new IconButton(
      icon: new SvgPicture.asset( "assets/svg/message.svg"),
      onPressed: () {
  ...
  Widget mEmojiButton() {
    return new IconButton(
      icon: new SvgPicture.asset( "assets/svg/emoji.svg"),
      onPressed: () {
  ...
  Widget mEmojiKeyBoardButton() {
    return new IconButton(
      icon: new SvgPicture.asset( "assets/svg/wink.svg"),
      onPressed: () {
        _getWH();
        this.mCurrentType = "text2";
        mBottomLayoutShow = true;
    ...
    return StreamBuilder<String>(
      ...
      builder: (context, snapshot) {
        ...
        final extraButton = IconButton(
            icon: new SvgPicture.asset( "assets/svg/plus.svg"),
            onPressed: () {
